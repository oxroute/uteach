...
<div>
    ...
    <img src="/Public/images/background.png" alt="" id="bg_pic">
	<div class="logo_center">
		<p><img src="/Public/images/logo_text.png" alt=""></p>
		<form action="login" method="post" id="from">
			...
			<img src="/Public/images/lod.gif" alt="" class="logo_load" />
	...
	<div id="footer">
		Copyright&nbsp;&copy;&nbsp;2014-2015&nbsp;TOPPDI&nbsp;保留所有权利。
	</div>
</body>
<script>
	$(function(){
